...
from flask_learning.api import all_blueprints
from flask_learning.config import admin_manager, db_instance, login_manager, settings
from flask_learning.models import all_models
from flask_learning.services import load_user
from flask_learning.utils import ORJSONProvider, register_error_handlers
