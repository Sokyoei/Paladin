...
@genshin_role_router.put("/create", summary="新建角色", response_model=Response[GenshinRoleResponse])
...
@genshin_role_router.post("/update", summary="更新角色", response_model=Response[GenshinRoleResponse])
...
@genshin_role_router.get("/search", summary="查找角色", response_model=Response[GenshinRoleResponse])
